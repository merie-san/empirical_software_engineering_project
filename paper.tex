...
Our objective is to thoroughly analyze the evolution of LLM API usage and their distribution, starting from the launch of ChatGPT in 2022, through the presence of imports for language-specific libraries and other metrics obtainable from a GitHub project's metadata. For this objective we queried the GitHub REST API for Python projects created between 2022 and 2025, ordering them by time.
...
In summary we did not find important papers detailing the popularity of various LLM technology through API usage but we did find foundational papers on LLM-integrated application development.
%------------------------------------------------
